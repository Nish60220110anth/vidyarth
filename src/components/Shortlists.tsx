...
export default function UserShortlistTable() {
    ...
    return (
        <div className="p-6 bg-gradient-to-b from-gray-950 to-gray-900 min-h-screen text-white font-[Urbanist]">
            <motion.div
                initial={{ opacity: 0, y: -10 }}
                animate={{ opacity: 1, y: 0 }}
                className="flex items-center justify-between mb-4"
            >
                <h2 className="text-2xl font-bold tracking-wide">Shortlists</h2>

                <button
                    onClick={fetchShortlists}
                    className="p-2 rounded-md border border-gray-700 text-gray-300 hover:text-cyan-400 hover:border-cyan-500 transition shadow-sm hover:shadow-md"
            ...
            <div className="mb-4">
                <input
                    ...
                    className="w-full px-4 py-2 rounded-lg bg-gray-900 border border-gray-800 text-cyan-100 placeholder:text-cyan-400 focus:outline-none focus:ring-2 focus:ring-cyan-600"
                    value={search}
            ...
            {loading ? (
                ...
                <div className="text-center text-cyan-600 italic mt-10">No shortlists found.</div>
            ) : (
                <>
                    {/* Desktop Table View */}
                    <div className="hidden md:block overflow-x-auto bg-gray-900 rounded-lg border border-gray-800 shadow-xl">
                        <table className="min-w-full text-sm text-left text-cyan-100">
                            <thead className="text-xs uppercase bg-gray-800 text-cyan-400">
                                <tr>
                                ...
                                {filteredShortlists.map((s) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-3">
                                            <span
                                                className={`text-xs px-2 py-1 rounded-full font-semibold ${SHORTLIST_TYPE_COLORS[s.shortlist_type] ||
                    ...
                    <div className="md:hidden space-y-4">
                        {filteredShortlists.map((s) => (
                            <motion.div
                                ...
                                className="bg-gray-900 border border-gray-800 rounded-lg p-4 shadow-md"
                            >

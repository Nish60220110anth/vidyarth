...
const subjectTemplates: Record<TemplateTypes, string> = {
  ...
  COMPANY: `{{company_full}} Has Been Added in Shukracharya`,
...
const briefTemplate: Record<TemplateTypes, string> = {
  ...
  COMPANY: `{{company_full}} has been added to the Shukracharya. Review company details and start preparing.`,
...
const contentBodies: Record<TemplateTypes, string> = {
  ...
  COMPANY: `Please be informed that <strong>{{company_full}}</strong> has now been added to the Shukracharya portal. All students are expected to thoroughly review the company details and familiarize themselves with the available material.`,

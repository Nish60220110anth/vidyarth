...
export default function LoginPage({
    ...
    return (
        <>
            ...
            {/* Online/Offline Chip (fixed, small; won’t collide with content) */}
            <div
            ...
            {/* Page Shell: grid with content + real footer; scroll-safe on tiny heights */}
            <div className="relative min-h-[100svh] bg-gradient-to-b from-[#0b1520] via-[#0a141d] to-[#0b1520] text-cyan-100 font-[Inter] overflow-x-hidden grid grid-rows-[1fr_auto]">

                {/* Background accents behind everything */}
                <div className="pointer-events-none absolute -top-24 -left-20 h-56 w-56 sm:h-72 sm:w-72 rounded-full blur-3xl opacity-25 bg-cyan-700/20 -z-10" />
                <div className="pointer-events-none absolute -bottom-28 -right-24 h-64 w-64 sm:h-80 sm:w-80 rounded-full blur-3xl opacity-25 bg-cyan-500/20 -z-10" />
                ...
                <main className="row-start-1 row-end-2 flex items-center justify-center px-4 sm:px-6 py-8 sm:py-10">
                            ...
                            <div className="rounded-2xl bg-[#0b1014]/90 border border-cyan-900/60 p-5 sm:p-8">
                                ...
                                <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5" noValidate>
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className="w-full pl-10 pr-4 py-2 sm:py-2.5 rounded-xl bg-[#0f1318] text-cyan-100 placeholder-cyan-400/70 border border-cyan-800 focus:outline-none focus:ring-1 focus:ring-cyan-500 transition text-sm sm:text-base"
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className="w-full pl-10 pr-12 py-2 sm:py-2.5 rounded-xl bg-[#0f1318] text-cyan-100 placeholder-cyan-400/70 border border-cyan-800 focus:outline-none focus:ring-1 focus:ring-cyan-500 transition text-sm sm:text-base"
                                                placeholder="••••••••"
                                                required
                                            />
                                            <button
                                    ...
                                    <button
                                        ...
                                        className="w-full bg-cyan-400 disabled:bg-cyan-700/40 disabled:text-cyan-200/60 hover:bg-cyan-300 text-[#0a141d] font-semibold py-2.5 px-4 rounded-xl shadow-sm transition duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-cyan-500"
                                    >

    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content="Recover your Vidyarth portal password. Contact Team Synapse for reset instructions." />
                <meta property="og:title" content="Forgot Password - Vidyarth Portal" />

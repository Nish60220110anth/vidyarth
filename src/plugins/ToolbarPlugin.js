...
import {
  $getNearestNodeOfType, mergeRegister, $findMatchingParent,
    ...
    >
      <SketchPicker
        ...
        onChangeComplete={(c) => {
          ...
          //   const selection = $getSelection();
          //   if (selection) {
          //     $patchStyleText(selection, { [property]: hex });
          //   }
          // });
          onChange(hex);
          onClose();
...
export default function ToolbarPlugin() {
  ...
  const bgColorPickerButtonRef = useRef(null);
      ...
      {blockType === "code" ? (
        ...
        <>
          ...
          {showColorPicker &&
            createPortal(
              <ColorPickerDropdown
                ...
                toolbarRef={colorPickerButtonRef}
                editor={editor}
                property={"color"}
              />,
              document.body
          ...
          <button
            ...
            aria-label="Pick Bg Text Color"
            ref={bgColorPickerButtonRef}
          >
            <PaintBucket
              style={{ color: bgColor, width: 18, height: 18 }}
              className="icon format"
            />
          </button>
          ...
          {showBgColorPicker &&
            createPortal(
              <ColorPickerDropdown
                ...
                toolbarRef={bgColorPickerButtonRef}
                editor={editor}
